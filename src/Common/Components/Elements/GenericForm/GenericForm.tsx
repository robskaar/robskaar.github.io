...
function GenericForm<entityType>(props: {
  ...
  footerConfig?:{IconClasses:{cancel?:string,submit?:string},hide?:boolean;}
  initialValues:entityType;
  sections?:{title:string,containedProperties?:[string],isOpen:boolean}[];
  ...
  return (
    <div className={styles.formWrapper}>
      ...
      >
        ...
        {props.sections?.map(
          (section: {title:string,containedProperties?:[string],isOpen:boolean}) => {
            return (
              <FormCollapsible
                key={section.title}
